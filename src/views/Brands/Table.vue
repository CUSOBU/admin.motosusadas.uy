<template>
  <div class="table-container">
    <datatable :headers="headers" :items="brands" :items-per-page="itemsPerPage" :page="page"
...
export default {
  ...
  setup(props: any) {
    ...
    const loadBrands = async (options: any = {}) => {
      try {
        const params = {
    ...
    const info = (id: string) => {
      router.push({ name: 'brands-details', params: { id } });
    };
