<template>
  <div class="table-container">
    <datatable :headers="headers" :items="agencies" :items-per-page="itemsPerPage" :page="page"
...
export default {
  ...
  setup(props: any) {
    ...
    const loadAgencies = async (options: any = {}) => {
    ...
    const edit = (id: string) => {
      router.push({ name: 'agencies-edit', params: { id } });
    };

    const info = (id: string) => {
      router.push({ name: 'agencies-details', params: { id } });
    };
